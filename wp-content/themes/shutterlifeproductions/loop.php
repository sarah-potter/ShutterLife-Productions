	...
	<?php if ( ( isset( $options['gallery_category'] ) && '0' != $options['gallery_category'] && in_category( $options['gallery_category'] ) ) || has_post_format( 'gallery' ) ) : ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="entry-info">
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'coraline' ), __( 'Leave a Comment', 'coraline' ), __( 'Leave a Comment', 'coraline' ) ); ?></span>
		...
		<?php endif; ?>
			...
			<div class="entry-info">
				<p class="comments-link">
					<?php comments_popup_link( __( 'Leave a comment', 'coraline' )); ?></p>
