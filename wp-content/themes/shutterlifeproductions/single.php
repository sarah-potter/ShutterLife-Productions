...
<div id="nav-above" class="navigation">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php if ( 'standard' == $format ) : ?>
				...
				<img class="blue-arrow" src="http://localhost:8888/wp-content/themes/shutterlifeproductions/images/small-blue-arrow.png">
				</div><!-- .entry-meta -->
				<img class="blog-dots" src="http://localhost:8888/wp-content/themes/shutterlifeproductions/images/orange-dots.png">
			<?php endif; ?>
